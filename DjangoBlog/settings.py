...
SECRET_KEY = "django-insecure-=asl1pqqn+*)dj7u)o@ffp&8h*vyv%)_tb3&lq=zu9yg*j9@@k"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {
                "markdown_tag": "libraries.filter.markdown_filter",  # Custom template filter for Markdown
            },
        },
    },
]
